<?php
/**
 * schedule.php: Quản lý Danh sách Lịch Khám Bệnh
 * Lưu ý: File này PHẢI return nv_admin_theme($contents) để main.php có thể hiển thị.
 */
...
// -------------------------
// 1️⃣ Danh sách lịch khám (action=list)
// -------------------------
if ($action == 'list') {
...
// -------------------------
// 2️⃣ Xem chi tiết lịch khám (action=detail)
// -------------------------
...
// -------------------------
// 3️⃣ Xác nhận, Hủy, Xóa (Xử lý GET)
// -------------------------
