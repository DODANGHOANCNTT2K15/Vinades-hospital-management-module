<div class="card">
    <div class="card-header">
        <h3 class="card-title">Thêm Lịch Khám Mới</h3>
    </div>
    <div class="card-body">
        ...
        <form action="{FORM_ACTION}" method="post">
            ...
            <h4 class="mt-4">2. Hồ Sơ Khám Bệnh (Tùy chọn)</h4>
            <hr>
            ...
            <div class="mt-4">
                <input type="submit" name="submit" value="Thêm Lịch Khám" class="btn btn-primary">
